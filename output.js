//Thu Sep 18 2025 08:48:49 GMT+0000 (Coordinated Universal Time)
      ...
      if (F) {
        {
          ...
          return "Map" === I || "Set" === I ? Array.from(F) : "Arguments" === I || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(I) ? f(F, G) : undefined;
        }
      }
    }
  }
        ...
        return g().wrap(function (at) {
          {
            for (;;) {
              switch (at.prev = at.next) {
                ...
                case 87:
                  aj = at.sent;
                  1 == aj.data.awardType ? (console.log("抽奖获得：".concat(null == aj || null === (ak = aj.data) || undefined === ak ? undefined : ak.award).concat(null == aj || null === (al = aj.data) || undefined === al ? undefined : al.name)), l += "用户：".concat(phone_number, " 抽奖获得：").concat(null == aj || null === (am = aj.data) || undefined === am ? undefined : am.award).concat(null == aj || null === (an = aj.data) || undefined === an ? undefined : an.name, "\n")) : 2 == aj.data.awardType ? (console.log("抽奖获得：".concat(null == aj || null === (ao = aj.data) || undefined === ao ? undefined : ao.scoreAward).concat(null == aj || null === (ap = aj.data) || undefined === ap ? undefined : ap.name)), l += "用户：".concat(phone_number, " 抽奖获得：").concat(null == aj || null === (aq = aj.data) || undefined === aq ? undefined : aq.scoreAward).concat(null == aj || null === (ar = aj.data) || undefined === ar ? undefined : ar.name, "\n")) : (console.log("谢谢参与"), l += "用户：".concat(phone_number, " 抽奖获得：谢谢参与\n"));
                case 89:
                  at.next = 83;
                  break;
                case 91:
